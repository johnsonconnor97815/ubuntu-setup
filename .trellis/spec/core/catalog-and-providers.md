...
- **install:** `apt-get install -y --no-install-recommends <pkg>`, with `-o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"` to survive modified-conffile prompts non-interactively.
