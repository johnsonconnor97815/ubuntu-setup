...
Prescriptive. The runner contract below bakes in the verified non-interactive idioms (apt prompts, locale, sudo env-stripping) so individual providers cannot get them wrong.
